...
function sendData(score, gameLength, questionsSolved) {
    /*
    console.log(score)
    ...
    fetch('/game/save_game_data/', {
        ...
        body: JSON.stringify( { score, gameLength, questionsSolved} )
    })
...
function startGame(gameLength) {
    ...
    let endTime = startTime + gameLength * 1000;
    ...
    function askQuestion() {
        ...
        answerBox.oninput = function() {
            ...
            if (userAnswer === correctAnswer) {
                ...
                let timeTaken = currentTime - startTime; // Time taken for the current question
